		...
		<div className="login-container h-dvh flex flex-col">
			...
			<div className="content flex justify-center items-center flex-1 flex-col w-1/4 mx-auto">
				...
				<Separator className="my-8 relative">
					<div
						className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-gray-100 text-[12px] px-1 py-0.5 rounded-[2px] text-gray-500 dark:text-white dark:bg-[#333] ">
						使用其他方式
					</div>
				</Separator>
				<Form {...form}>
